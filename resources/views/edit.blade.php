...
<head>
  ...
  <link href="{{asset('assets/ss/style-responsive.css')}}" rel="stylesheet">
          ...
          <div class="col-md-12">
            <section class="task-panel tasks-widget">
              <div class="panel-heading">
                <div class="pull-left">
                  <h5><i class="fa fa-tasks"></i>Editer</h5>
                </div>
                <br>
              </div>
              <div class="panel-body">
                <div class="task-content">
                  ...
                  <form action="{{route('edition',['id'=>$editer->id])}}" method="post">
                    @csrf
                    <input type="text" name="tache" value="{{$editer->name}}">
                    <input type="submit" value="edter">
                  </form>
                 
                </div>
                <div class=" add-task-row">
                  <a class="btn btn-success btn-sm pull-left" href="/">Retour</a>
